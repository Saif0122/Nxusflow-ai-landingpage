...
const testimonials = [
  {
    ...
    image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=100&h=100&q=60&fm=webp",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=100&h=100&q=60&fm=webp",
    quote: "The cleanest UI I've ever seen in a SaaS product. It's actually a joy to use daily."
  },
  {
    name: "Elena Rodriguez",
    role: "Operations Director",
    image: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&w=100&h=100&q=60&fm=webp",
    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center" aria-labelledby="testimonials-heading">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {testimonials.map((t, idx) => (
          <div key={idx} className="p-8 glass-morphism rounded-3xl border border-white/5 text-left transition-all hover:bg-white/[0.05]">
            <div className="flex items-center space-x-4 mb-6">
              <div className="w-12 h-12 rounded-full overflow-hidden bg-gray-800 shrink-0">
                <img 
                  ...
                  loading="lazy"
                  decoding="async"
                  className="w-full h-full object-cover border-2 border-indigo-500/20" 
                />
              </div>
              <div>
            ...
            <div className="mt-6 flex text-yellow-500" aria-label="5 star rating">
              {[...Array(5)].map((_, i) => (
