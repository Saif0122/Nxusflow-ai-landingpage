      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center bg-indigo-600 rounded-[2.5rem] p-12 mb-20 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <button className="px-10 py-5 bg-white text-indigo-600 rounded-2xl font-bold text-xl hover:shadow-2xl hover:scale-105 transition-all">
              Join the Waitlist
            </button>
          </div>
          {/* Subtle background circles for the CTA footer */}
          <div className="absolute -top-10 -right-10 w-64 h-64 bg-white/10 rounded-full blur-3xl"></div>
          <div className="absolute -bottom-10 -left-10 w-64 h-64 bg-indigo-800 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16 text-center md:text-left">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Making work intelligent, one task at a time. Built with love in London.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-500">
              ...
              <li><a href="#" className="hover:text-indigo-400">Enterprise</a></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex space-x-4 justify-center md:justify-start">
              <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-indigo-600 transition-colors cursor-pointer">
